...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider.value(
      value: FirebaseProvider.instance(),
      child: Consumer(
        builder: (context, FirebaseProvider firebase, _) {
          return Scaffold(
                            ...
                            ButtonTheme(
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () {
                                  ...
                                  var data =
                                      _createDataUser(name, org, gst, email);
                                  Provider.of<FirebaseProvider>(context).fireInsertUser(data);
                                },
                                child: Text(
                                  "Submit",
